...
using LogViewExample.Utilities;
...
namespace LogViewExample
{
    public partial class MainWindow
    {
        ...
        public MainWindow()
        {
            ...
            LogList.MouseEnter += (sender, args) => LogListOnMouseEnter();
            LogList.MouseLeave += (sender, args) => LogListOnMouseLeave();

            Timer = new Timer(x => AddRandomEntry(), null, 1000, 10);
        }

        /// <summary>
        /// On MouseLeave, the timer will resume.
        /// </summary>
        private void LogListOnMouseLeave()
        {
            Timer.Change(1000, 10);
        }

        /// <summary>
        /// On MouseEnter, the timer will pause so the user can examine the log entries. 
        /// </summary>
        private void LogListOnMouseEnter()
        {
